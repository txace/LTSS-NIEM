...
- Populate your Email table with your desired configuration data for summary notifications.  It would be prudent to validate your configuration data with `EmailHelper.SendEmail`.
